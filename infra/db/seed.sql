...
-- ══════════════════════════════════════════════════════════════════
($$Martin Luther King Jr.$$, $$individual$$,
 $$Baptist minister, civil rights leader, and Nobel Peace Prize laureate (1964). Led the Montgomery Bus Boycott (1955–56), the March on Washington (1963), and the Selma to Montgomery marches (1965). Assassinated 4 April 1968. Also searchable as MLK Jr.$$,
 7, 8, 7, 10, 10, 9, 8.5,
 $$No significant environmental record in the 1950s–60s political context. No documented environmental harms. Score: 7 (neutral era-adjusted; insufficient evidence to score higher).$$,
 $$Championed workers' rights explicitly: the Poor People's Campaign (1967–68) sought a guaranteed income and targeted economic inequality; was in Memphis supporting striking sanitation workers at the time of his assassination (AFSCME Local 1733, 1968). Consistently allied with organized labor. Score: 8.$$,
 $$No criminal convictions. Subject to illegal FBI COINTELPRO surveillance and harassment campaign orchestrated by J. Edgar Hoover — documented by Church Committee (1975) and confirmed by federal records. Never charged with any crime. Score: 7 (minor deduction for documented personal conduct concerns in FBI files, though those files were compiled under a politically motivated and illegal surveillance programme; no independent corroboration of the most serious allegations).$$,
 $$Led the most consequential nonviolent civil rights movement in US history. Directly contributed to the Civil Rights Act (1964) and Voting Rights Act (1965), landmark legislation that dismantled legal segregation. Vocal opponent of the Vietnam War (Beyond Vietnam speech, 1967) despite the political cost. Advocate for Palestinian rights and anti-colonialism. Score: 10.$$,
 $$Nobel Peace Prize (1964). Founded and led the Southern Christian Leadership Conference (SCLC). Organised and inspired mass civic participation across the American South and nation. Speeches and writings (Letter from Birmingham Jail, I Have a Dream) remain foundational civic documents. Poor People's Campaign targeted structural poverty. Score: 10.$$,
 $$No real criminal record. No associations with convicted criminals. Subjected to an illegal federal campaign to destroy his reputation and marriage (COINTELPRO, Church Committee, 1975) — classified documents later released under FOIA confirm systematic government misconduct, not personal wrongdoing. Score: 9.$$)

-- End of values list
ON CONFLICT DO NOTHING;

-- ══════════════════════════════════════════════════════════════════
-- 77. Coretta Scott King
-- ══════════════════════════════════════════════════════════════════
INSERT INTO entities (name, entity_type, description,
  score_env, score_labor, score_integrity, score_political, score_community, score_conduct, score_avg,
  reason_env, reason_labor, reason_integrity, reason_political, reason_community, reason_conduct)
VALUES
($$Coretta Scott King$$, $$individual$$,
 $$Civil rights leader, author, and activist. Wife and collaborator of Martin Luther King Jr.; continued and expanded his legacy after his assassination in 1968. Founded the King Center for Nonviolent Social Change (1968) in Atlanta. Advocate for LGBTQ+ rights, women's rights, nuclear disarmament, and South African apartheid opposition. Opposed the Iraq War (2003).$$,
 7, 10, 10, 10, 10, 10, 9.5,
 $$No significant environmental record; no documented environmental harms. Vocal supporter of nuclear disarmament, which carries indirect environmental benefit. Score: 7 (era-adjusted neutral).$$,
 $$Championed economic justice and workers' rights throughout her life, consistent with the Poor People's Campaign she continued after MLK Jr.'s death. Supported organized labour and spoke at numerous union events. Score: 10.$$,
 $$No criminal convictions; no documented financial misconduct. The King Center operated with documented transparency. No credible allegations of personal wrongdoing. Score: 10.$$,
 $$Led opposition to apartheid in South Africa and lobbied successfully for the US Comprehensive Anti-Apartheid Act (1986). Opposed the Gulf War (1991) and Iraq War (2003) at significant political cost. Among the earliest prominent mainstream voices advocating for LGBTQ+ civil rights (publicly stated in 2000 that same-sex unions deserved the same rights as marriage). Campaigned for the MLK federal holiday, signed into law 1983. Score: 10.$$,
 $$Founded the King Center (1968), which has educated millions on nonviolent social change. Established Martin Luther King Jr. Day as a nationally observed institution. Author of My Life with Martin Luther King Jr. (1969) and a sustained public intellectual presence for four decades. Score: 10.$$,
 $$No criminal record; no associations with convicted criminals. Demonstrated extraordinary personal resilience and moral consistency across a 40-year public career following her husband's assassination. Score: 10.$$)
ON CONFLICT DO NOTHING;

-- Aliases: alternate names that point to the canonical entry
-- The lookup query uses ILIKE '%term%', so short aliases need their own rows.
INSERT INTO entities (name, entity_type, description,
  score_env, score_labor, score_integrity, score_political, score_community, score_conduct, score_avg,
  reason_env, reason_labor, reason_integrity, reason_political, reason_community, reason_conduct)
SELECT
  $$MLK Jr.$$, entity_type, description,
  score_env, score_labor, score_integrity, score_political, score_community, score_conduct, score_avg,
  reason_env, reason_labor, reason_integrity, reason_political, reason_community, reason_conduct
FROM entities WHERE name = $$Martin Luther King Jr.$$
ON CONFLICT DO NOTHING;
...
INSERT INTO entities (name, entity_type, description,
  ...
  reason_env, reason_labor, reason_integrity, reason_political, reason_community, reason_conduct)
SELECT
  $$Coretta King$$, entity_type, description,
  score_env, score_labor, score_integrity, score_political, score_community, score_conduct, score_avg,
  reason_env, reason_labor, reason_integrity, reason_political, reason_community, reason_conduct
FROM entities WHERE name = $$Coretta Scott King$$
ON CONFLICT DO NOTHING;
