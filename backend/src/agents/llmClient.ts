...
- Conduct: personal behaviour outside formal roles — patterns of abuse, harassment, exploitation, or exemplary integrity and restraint. Actively promoting or profiting from unethical behaviour (e.g. encouraging cheating, fraud, deception, predatory gambling, or exploitation of vulnerable people) should lower this score proportionally to the scale and intent. Consensual adult infidelity, without coercion or abuse of power, should normally stay near neutral (around 5) unless it forms part of a broader harmful pattern.
